 ...
 * @author harism
 */
public class ChapterTwoActivity extends Activity {
    ...
    private class PageProvider implements CurlView.PageProvider {
        ...
        // Bitmap resources.
        private int[] mBitmapIds = { R.drawable.chaptertwotitle, R.drawable.chaptertwopageone,
                R.drawable.chaptertwopagethree, R.drawable.chaptertwopagefour,
                R.drawable.chaptertwopagefive, R.drawable.chaptertwopagesix,
                R.drawable.chaptertwopageseven, R.drawable.chaptertwopageight,
                R.drawable.chaptertwopagenine,R.drawable.chaptertwopageten,
                R.drawable.chaptertwopageleven,
                R.drawable.chaptertwopagetwelve,
                R.drawable.chaptertwopagethir};
