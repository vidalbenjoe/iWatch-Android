...
public class HelpDeskNoConnection extends Activity {
    ...
    public class NetworkChangeReceiver extends BroadcastReceiver {
        ...
        private boolean isNetworkAvailable(Context context) {
                ...
                if (info != null) {
                    for (int i = 0; i < info.length; i++) {
                        if (info[i].getState() == NetworkInfo.State.CONNECTED) {
                            if(!isConnected){
                                Intent view = new Intent(getApplicationContext(), ViewHelpDeskQuestions.class);
            ...
            showAlertDialog(HelpDeskNoConnection.this, "No Internet Connection",
