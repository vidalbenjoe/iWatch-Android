 ...
 * @author harism
 */
public class ChapterFourActivity extends Activity {
    ...
    private class PageProvider implements CurlView.PageProvider {
        ...
        private int[] mBitmapIds = {
                R.drawable.chapterfourtitle, R.drawable.chapterfourpageone,
                R.drawable.chapterfourpagetwo,R.drawable.chapterfourpagethree,
                R.drawable.chapterfourpagefour,R.drawable.chapterfourpagefive,
                R.drawable.chapterfourpagesix, R.drawable.chapterfourpageseven,
                R.drawable.chapterfourpageeight,R.drawable.chapterfourpagenine,
                R.drawable.chapterfourpageten,R.drawable.chapterfourpageeleven,
                R.drawable.chapterfourpagetwelve,R.drawable.chapterfourpagethirteen,
                R.drawable.chapterfourpagefourteen, R.drawable.chapterfourpagefifthteen
