...
public class RegNoCon extends Activity {
    ...
    public class NetworkChangeReceiver extends BroadcastReceiver {
        ...
        private boolean isNetworkAvailable(Context context) {
                ...
                if (info != null) {
                    for (int i = 0; i < info.length; i++) {
                        if (info[i].getState() == NetworkInfo.State.CONNECTED) {
                            if(!isConnected){
                                Intent view = new Intent(getApplicationContext(), Registration_Activity.class);
            ...
            showAlertDialog(RegNoCon.this, "No Internet Connection",
    ...
    public void showAlertDialog(Context context, String title, String message, Boolean status) {
        ...
        alertDialog.setButton("OK", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                Intent view = new Intent(getApplicationContext(), RegSignDahboardActivity.class);
