...
public class ChapterOneActivity extends Activity {
    ...
    private class PageProvider implements CurlView.PageProvider {
        ...
        private int[] mBitmapIds = {
                R.drawable.chapteronetitle, R.drawable.chapteronepageone,
                R.drawable.chapteronepagetwo, R.drawable.chapteronepagethree,
                R.drawable.chapteronepagefour,R.drawable.chapteronepagefive
        };
