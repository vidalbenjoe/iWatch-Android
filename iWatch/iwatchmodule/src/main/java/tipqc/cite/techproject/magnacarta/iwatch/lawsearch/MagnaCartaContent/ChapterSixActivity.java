 ...
 * @author harism
 */
public class ChapterSixActivity extends Activity {
    ...
    private class PageProvider implements CurlView.PageProvider {
        ...
        private int[] mBitmapIds = {
                R.drawable.chaptersixtitle, R.drawable.chaptersixpageone,
                R.drawable.chaptersixpagetwo,R.drawable.chaptersixpagethree,
                R.drawable.chaptersixpagefive, R.drawable.chaptersixpagesix,
                R.drawable.chaptersixpageseven, R.drawable.chaptersixpageeight,
                R.drawable.chaptersixpagenine, R.drawable.chaptersixpageten,
                R.drawable.chaptersixpageeleven, R.drawable.chaptersixpagetwelve,
                R.drawable.chaptersixpagethirteen, R.drawable.chaptersixpagefourhteen,
                R.drawable.chaptersixpagefifthteen
